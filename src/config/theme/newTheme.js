const primaryColor = "#1D429C"; // #E7833B orange #BF1E2E
const primaryHover = "#2C99FF"; // #FFECDD
const secondaryColor = "#e53f4f"; // red
const secondaryHover = "#f7f7f7";
const textPrimary = "#1D429C"; //
const textSecondary = "#BF1E2E"; //
const linkColor = "#0D79DF"; // #FF6D00
...
const primaryIconColor = "#2C99FF"; // "#fb5666";
const secondaryIconColor = "#0D79DF"; // "#e53f4f";
const btnlg = "56px";
const btnsm = "36px";
const btnxs = "29px";
